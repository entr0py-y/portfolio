            ...
            <div className="flex flex-col items-start gap-3">
              <div className="flex items-center relative w-full max-[768px]:relative max-[768px]:w-full max-[768px]:h-[180px] max-[768px]:mb-2">
                ...
                <img
                  src="/signature.png"
                  alt="Signature"
                  className="signature-img absolute left-[160px] right-0 mx-auto w-[380px] object-contain opacity-85 rotate-[30deg] pointer-events-none max-[768px]:absolute max-[768px]:left-[120px] max-[768px]:right-0 max-[768px]:mx-auto max-[768px]:top-1/2 max-[768px]:-translate-y-1/2 max-[768px]:rotate-[25deg] max-[768px]:w-[220px] max-[768px]:z-[20]"
                />
              </div>
