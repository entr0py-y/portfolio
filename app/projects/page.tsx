      ...
      <div className="fade-in fade-in-delay-2" style={{ fontFamily: "var(--font-body)" }}>
        ...
        <div className="flex flex-col gap-20">
          ...
          <section>
            ...
            <div className="text-[13px] text-[var(--color-outline)] font-medium mb-4">
              Assistive system for visually impaired
            </div>
            <p className="text-[14px] leading-[1.6] text-[var(--color-on-background)] mb-5">
            ...
            <ul className="flex flex-col gap-3 list-none p-0 m-0">
              {[
                ...
                <li key={idx} className="text-[13px] text-[var(--color-outline)] flex gap-3 items-start">
        ...
        <p className="text-[12px] text-[var(--color-outline)] mt-20 italic">
          more in the works.
        </p>
      </div>
    </PageShell>
